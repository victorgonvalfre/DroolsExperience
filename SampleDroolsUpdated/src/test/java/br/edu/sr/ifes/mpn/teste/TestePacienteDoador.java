...
public class TestePacienteDoador {

	private RuleEngine ruleEngine = new RuleEngine();
	private final String DSLRFile = "PacienteDoador.dslr";
	private final String DSLFile = "PacienteDoador.dsl";
	...
	public void testePacienteDoador()
	{
    	...
    	//Criando Doacao
    	Doacao doacao = new Doacao(true, obito);
