...
public class TestePacienteNaoDoadorTime {

	private RuleEngine ruleEngine = new RuleEngine();
	private final String DSLRFile = "PacienteNaoDoadorTime.dslr";
	private final String DSLFile = "PacienteNaoDoadorTime.dsl";
	...
	public void testePacienteDoador()
	{
       	...
       	dateAux.setHours(dateAux.getHours()+8);
