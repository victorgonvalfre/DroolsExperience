...
public class TestePacienteNaoDoadorDoenca {

	private RuleEngine ruleEngine = new RuleEngine();
	private final String DSLRFile = "PacienteNaoDoadorDoenca.dslr";
	private final String DSLFile = "PacienteNaoDoadorDoenca.dsl";
